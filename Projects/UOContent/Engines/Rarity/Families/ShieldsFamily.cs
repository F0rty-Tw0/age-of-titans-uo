...
public static class ShieldsFamily
{
    public static readonly ShieldFamilyDefinition Definition = new()
    {
        ...
        Legendaries = new[]
        {
            ...
            new LegendaryEntry(219, "Telamon", VariantRoot.Aegis, LegendaryRegistry.FamilyShields, 3, ClauseType.ParryRepairsEveryN, 10, 0, 0, 0),
            ...
            new LegendaryEntry(222, "Amphion", VariantRoot.Amyntor, LegendaryRegistry.FamilyShields, 0, ClauseType.ReflectFirstHit, 15, 0, 0, 0), // SWAP FlameProcDoubleLowDurability
            new LegendaryEntry(223, "Zethos", VariantRoot.Amyntor, LegendaryRegistry.FamilyShields, 1, ClauseType.SelfRepairBurstOnCritBlock, 5, 0, 0, 0),
            new LegendaryEntry(224, "Proitos", VariantRoot.Amyntor, LegendaryRegistry.FamilyShields, 2, ClauseType.ReflectBoostFirstHit, 15, 0, 0, 0),
            new LegendaryEntry(225, "Tiryns", VariantRoot.Amyntor, LegendaryRegistry.FamilyShields, 3, ClauseType.ReflectHealBlock, 15, 3, 0, 0), // SWAP FlameProcEveryN
            new LegendaryEntry(226, "Danaos", VariantRoot.Amyntor, LegendaryRegistry.FamilyShields, 4, ClauseType.SelfRepairRestoresHp, 1, 0, 0, 0),
            new LegendaryEntry(227, "Akrisios", VariantRoot.Amyntor, LegendaryRegistry.FamilyShields, 5, ClauseType.ReflectCritStun, 0, 0, 0, 0),
            ...
            new LegendaryEntry(230, "Aiakos", VariantRoot.Pnoe, LegendaryRegistry.FamilyShields, 2, ClauseType.BlockRestoreStam, 10, 0, 0, 0), // SWAP HealBlockOnFirstHitLanded
            ...
            new LegendaryEntry(234, "Laomedon", VariantRoot.Herkos, LegendaryRegistry.FamilyShields, 0, ClauseType.SpellDrBoostFirstHit, 12, 0, 0, 0),
            ...
            new LegendaryEntry(236, "Palaimon", VariantRoot.Herkos, LegendaryRegistry.FamilyShields, 2, ClauseType.SpellDrBurstOnCritTaken, 3, 2, 0, 0),
            ...
            new LegendaryEntry(238, "Megareus", VariantRoot.Herkos, LegendaryRegistry.FamilyShields, 4, ClauseType.SpellDrVsPoisonDot, 0, 0, 0, 0),
            new LegendaryEntry(239, "Hyperbios", VariantRoot.Herkos, LegendaryRegistry.FamilyShields, 5, ClauseType.FirstHitNoSecondaryEffect, 0, 0, 0, 0),

            // was Talarian line → Probolos (the breakwater)
            new LegendaryEntry(240, "Panoptes", VariantRoot.Probolos, LegendaryRegistry.FamilyShields, 0, ClauseType.BlockRestoreStam, 10, 0, 0, 0), // SWAP DodgeRegenBurst
            new LegendaryEntry(241, "Abderos", VariantRoot.Probolos, LegendaryRegistry.FamilyShields, 1, ClauseType.ParryFirstHitGuaranteed, 0, 0, 0, 0),
            new LegendaryEntry(242, "Myrtilos", VariantRoot.Probolos, LegendaryRegistry.FamilyShields, 2, ClauseType.BlockDrainStam, 2, 0, 0, 0), // SWAP WeightReductionSuiteBurstOnDodge
            new LegendaryEntry(243, "Kerberos", VariantRoot.Probolos, LegendaryRegistry.FamilyShields, 3, ClauseType.ParryFirstHitGuaranteed, 0, 0, 0, 0),
            new LegendaryEntry(244, "Lasthenes", VariantRoot.Probolos, LegendaryRegistry.FamilyShields, 4, ClauseType.BlockManaLeech, 10, 0, 0, 0), // SWAP StamRegenMirrorsManaHalf
            new LegendaryEntry(245, "Melanippos", VariantRoot.Probolos, LegendaryRegistry.FamilyShields, 5, ClauseType.BlockNextShotCrit, 0, 0, 0, 0) // SWAP OnKillStamRestoreExtendImmunity
        }
    };
}
