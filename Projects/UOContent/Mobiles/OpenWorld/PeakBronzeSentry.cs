...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Peaks Expansion, L5, Bronze Watch. Donor: Stone Gargoyle.
[SerializationGenerator(0, false)]
public partial class PeakBronzeSentry : BaseCreature
{
    [Constructible]
    public PeakBronzeSentry() : base(AIType.AI_Melee)
    {
        Body = 67;
        Hue = 0x0798;
        BaseSoundID = 0x174;
    ...
    public override string DefaultName => "a bronze sentry";
