...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Mire Expansion, Cult of Lerna, L6. Donor: Giant Serpent.
[SerializationGenerator(0, false)]
public partial class MireLernaServant : BaseCreature
{
    [Constructible]
    public MireLernaServant() : base(AIType.AI_Melee)
    {
        Body = 0x15;
        Hue = 0x0491;
        BaseSoundID = 219;
    ...
    public override string DefaultName => "a Lerna hydra-servant";
