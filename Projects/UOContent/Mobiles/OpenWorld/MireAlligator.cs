...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Mire, L5. Donor: Alligator.
[SerializationGenerator(0, false)]
public partial class MireAlligator : BaseCreature
{
    [Constructible]
    public MireAlligator() : base(AIType.AI_Melee)
    {
        Body = 0xCA;
        Hue = 0x0844;
        BaseSoundID = 660;
    ...
    public override string DefaultName => "a mire alligator";
