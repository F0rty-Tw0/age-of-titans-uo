...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Mire Expansion, ambient, L5. Donor: Crane.
[SerializationGenerator(0, false)]
public partial class MireHeron : BaseCreature
{
    [Constructible]
    public MireHeron() : base(AIType.AI_Melee)
    {
        Body = 254;
        Hue = 0x0844;
        BaseSoundID = 0x4D7;
    ...
    public override string DefaultName => "a marsh heron";
