...
public partial class GroveWhitehart : BaseCreature
{
    [Constructible]
    public GroveWhitehart() : base(AIType.AI_Melee)
    {
        Body = 0xEA;
        Hue = 0x0851;
    ...
    public override string CorpseName => "a white hart corpse";
    public override string DefaultName => "a white hart";
