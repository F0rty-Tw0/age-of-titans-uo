...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Peaks Expansion, L5. Donor: Polar Bear.
[SerializationGenerator(0, false)]
public partial class PeakFrostbear : BaseCreature
{
    [Constructible]
    public PeakFrostbear() : base(AIType.AI_Melee)
    {
        Body = 213;
        Hue = 0x0492;
        BaseSoundID = 0xA3;
    ...
    public override string DefaultName => "a frost bear";
