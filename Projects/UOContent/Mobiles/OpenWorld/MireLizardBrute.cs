...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Mire Expansion, L6. Donor: Lizardman.
[SerializationGenerator(0, false)]
public partial class MireLizardBrute : BaseCreature
{
    [Constructible]
    public MireLizardBrute() : base(AIType.AI_Melee)
    {
    ...
    public override string DefaultName => "a fen lizard brute";
