...
public partial class RestlessLegionPikeman : BaseCreature
{
    [Constructible]
    public RestlessLegionPikeman() : base(AIType.AI_Melee)
    {
        Body = 57;
        Hue = 0x0481;
        BaseSoundID = 451;
    ...
    public override string DefaultName => "a barrow pikeman";
