...
public partial class RestlessLegionStandard : BaseCreature
{
    [Constructible]
    public RestlessLegionStandard() : base(AIType.AI_Melee)
    {
        Body = 147;
        Hue = 0x0847;
        BaseSoundID = 451;
    ...
    public override string DefaultName => "a barrow standard-bearer";
