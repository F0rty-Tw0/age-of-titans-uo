...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Peaks Expansion, L4. Donor: Grizzly Bear.
[SerializationGenerator(0, false)]
public partial class PeakBear : BaseCreature
{
    [Constructible]
    public PeakBear() : base(AIType.AI_Melee)
    {
        Body = 212;
        Hue = 0x0455;
        BaseSoundID = 0xA3;
    ...
    public override string DefaultName => "a mountain bear";
