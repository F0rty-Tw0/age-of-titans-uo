...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Shore, L4. Donor: Giant Serpent
// (land-walking body, not Sea Serpent - see spec note on CantWalk).
[SerializationGenerator(0, false)]
public partial class ShoreBrineserpent : BaseCreature
{
    [Constructible]
    public ShoreBrineserpent() : base(AIType.AI_Melee)
    {
        Body = 0x15;
        Hue = 0x0851;
        BaseSoundID = 219;
    ...
    public override string DefaultName => "a shoal serpent";
