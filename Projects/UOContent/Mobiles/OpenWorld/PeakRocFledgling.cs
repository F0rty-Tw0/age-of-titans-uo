...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Peaks Expansion, L4. Donor: Harpy.
[SerializationGenerator(0, false)]
public partial class PeakRocFledgling : BaseCreature
{
    [Constructible]
    public PeakRocFledgling() : base(AIType.AI_Melee)
    {
        Body = 30;
        Hue = 0x0492;
        BaseSoundID = 402;
    ...
    public override string DefaultName => "a roc fledgling";
