...
public partial class RestlessBellringer : BaseCreature
{
    [Constructible]
    public RestlessBellringer() : base(AIType.AI_Melee)
    {
    ...
    public override string DefaultName => "a corpse bellringer";
