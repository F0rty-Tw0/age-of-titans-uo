...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Shore, L4, the Deep Court. Donor: Water Elemental.
[SerializationGenerator(0, false)]
public partial class ShoreDeepTideguard : BaseCreature
{
    [Constructible]
    public ShoreDeepTideguard() : base(AIType.AI_Melee)
    {
        Body = 16;
        Hue = 0x0530;
        BaseSoundID = 278;
    ...
    public override string DefaultName => "a tide-guard of the deep";
