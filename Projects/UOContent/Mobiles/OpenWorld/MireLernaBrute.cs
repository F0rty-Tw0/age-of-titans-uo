...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Mire Expansion, Cult of Lerna, L6. Donor: Lizardman.
[SerializationGenerator(0, false)]
public partial class MireLernaBrute : BaseCreature
{
    [Constructible]
    public MireLernaBrute() : base(AIType.AI_Melee)
    {
    ...
    public override string DefaultName => "a Lerna enforcer";
