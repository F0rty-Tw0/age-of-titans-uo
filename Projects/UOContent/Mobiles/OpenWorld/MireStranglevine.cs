...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Mire Expansion, L6. Donor: Corpser.
[SerializationGenerator(0, false)]
public partial class MireStranglevine : BaseCreature
{
    [Constructible]
    public MireStranglevine() : base(AIType.AI_Melee)
    {
        Body = 8;
        Hue = 0x0851;
        BaseSoundID = 684;
    ...
    public override string DefaultName => "a strangle-vine";
