...
public partial class PeakTwoheadEttin : BaseCreature
{
    [Constructible]
    public PeakTwoheadEttin() : base(AIType.AI_Melee)
    {
        Body = 18;
        Hue = 0x0492;
        BaseSoundID = 367;
    ...
    public override string DefaultName => "a two-head crag ettin";
