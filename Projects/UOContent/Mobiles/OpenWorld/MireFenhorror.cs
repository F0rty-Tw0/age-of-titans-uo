...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Mire Expansion, L6. Donor: Bog Thing.
[SerializationGenerator(0, false)]
public partial class MireFenhorror : BaseCreature
{
    [Constructible]
    public MireFenhorror() : base(AIType.AI_Melee)
    {
        Body = 780;
        Hue = 0x0844;
    ...
    public override string DefaultName => "a fen horror";
