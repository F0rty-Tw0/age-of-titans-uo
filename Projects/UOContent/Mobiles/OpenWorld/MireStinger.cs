...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Mire Expansion, L5. Donor: Scorpion.
[SerializationGenerator(0, false)]
public partial class MireStinger : BaseCreature
{
    [Constructible]
    public MireStinger() : base(AIType.AI_Melee)
    {
        Body = 48;
        Hue = 0x0851;
        BaseSoundID = 397;
    ...
    public override string DefaultName => "a marsh stinger";
