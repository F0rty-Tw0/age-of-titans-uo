...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Shore, L4, the Deep Court. Donor: Harpy.
[SerializationGenerator(0, false)]
public partial class ShoreDeepNereid : BaseCreature
{
    [Constructible]
    public ShoreDeepNereid() : base(AIType.AI_Melee)
    {
        Body = 30;
        Hue = 0x0481;
        BaseSoundID = 402;
    ...
    public override string DefaultName => "a deep nereid";
