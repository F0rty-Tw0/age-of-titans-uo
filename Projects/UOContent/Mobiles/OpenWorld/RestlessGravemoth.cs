...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Restless (ambient), L2. Donor: Mongbat.
[SerializationGenerator(0, false)]
public partial class RestlessGravemoth : BaseCreature
{
    [Constructible]
    public RestlessGravemoth() : base(AIType.AI_Melee)
    {
        Body = 39;
        Hue = 0x0454;
        BaseSoundID = 422;
    ...
    public override string DefaultName => "a grave moth";
