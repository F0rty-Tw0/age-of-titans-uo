...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Peaks Expansion, L4, Get of Polyphemos. Donor: Ettin.
[SerializationGenerator(0, false)]
public partial class PeakGetShepherd : BaseCreature
{
    [Constructible]
    public PeakGetShepherd() : base(AIType.AI_Melee)
    {
        Body = 18;
        Hue = 0x0492;
        BaseSoundID = 367;
    ...
    public override string DefaultName => "a cyclops shepherd";
