...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Shore, L4, the Deep Court. Donor: Evil Mage
// (human body; T2A has no distinct oracle body).
[SerializationGenerator(0, false)]
public partial class ShoreDeepOracle : BaseCreature
{
    [Constructible]
    public ShoreDeepOracle() : base(AIType.AI_Mage)
    {
        Body = 0x190;
        Hue = 0x0481;
    ...
    public override string DefaultName => "a deep-court oracle";
