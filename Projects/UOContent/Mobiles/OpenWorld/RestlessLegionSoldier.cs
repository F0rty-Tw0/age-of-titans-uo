...
public partial class RestlessLegionSoldier : BaseCreature
{
    [Constructible]
    public RestlessLegionSoldier() : base(AIType.AI_Melee)
    {
    ...
    public override string DefaultName => "a barrow legionary";
