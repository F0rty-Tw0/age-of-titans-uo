...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Peaks Expansion, L4. Donor: Cougar.
[SerializationGenerator(0, false)]
public partial class PeakLion : BaseCreature
{
    [Constructible]
    public PeakLion() : base(AIType.AI_Melee)
    {
        Body = 63;
        Hue = 0x0455;
        BaseSoundID = 0x73;
    ...
    public override string CorpseName => "a lion corpse";
