...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Peaks Expansion, L4, Bronze Watch. Donor: Golem.
[SerializationGenerator(0, false)]
public partial class PeakBronzeWatchman : BaseCreature
{
    [Constructible]
    public PeakBronzeWatchman() : base(AIType.AI_Melee)
    {
        Body = 752;
        Hue = 0x0798;
    ...
    public override string DefaultName => "a bronze watchman";
