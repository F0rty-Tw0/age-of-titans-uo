...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Mire, L5. Donor: Giant Serpent.
[SerializationGenerator(0, false)]
public partial class MireSerpentspawn : BaseCreature
{
    [Constructible]
    public MireSerpentspawn() : base(AIType.AI_Melee)
    {
        Body = 0x15;
        Hue = 0x0851;
        BaseSoundID = 219;
    ...
    public override string DefaultName => "a lernaean spawn";
