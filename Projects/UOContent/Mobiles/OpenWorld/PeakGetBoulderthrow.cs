...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Peaks Expansion, L5, Get of Polyphemos. Donor: Ettin.
[SerializationGenerator(0, false)]
public partial class PeakGetBoulderthrow : BaseCreature
{
    [Constructible]
    public PeakGetBoulderthrow() : base(AIType.AI_Archer)
    {
        Body = 18;
        Hue = 0x0455;
        BaseSoundID = 367;
    ...
    public override string DefaultName => "a boulder-thrower";
