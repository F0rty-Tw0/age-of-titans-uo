...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Peaks Expansion, L4. Donor: Cyclops.
[SerializationGenerator(0, false)]
public partial class PeakCyclopsYoung : BaseCreature
{
    [Constructible]
    public PeakCyclopsYoung() : base(AIType.AI_Melee)
    {
        Body = 75;
        Hue = 0x0455;
        BaseSoundID = 604;
    ...
    public override string DefaultName => "a young cyclops";
