...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Mire Expansion, L5. Donor: Giant Toad.
[SerializationGenerator(0, false)]
public partial class MireToadspawn : BaseCreature
{
    [Constructible]
    public MireToadspawn() : base(AIType.AI_Melee)
    {
        Body = 80;
        Hue = 0x0851;
        BaseSoundID = 0x26B;
    ...
    public override string DefaultName => "a warty toad";
