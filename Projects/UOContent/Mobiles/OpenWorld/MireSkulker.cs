...
// Open-World Bestiary (dev-docs/open-world-bestiary.md) - Mire, L5. Donor: Lizardman.
[SerializationGenerator(0, false)]
public partial class MireSkulker : BaseCreature
{
    [Constructible]
    public MireSkulker() : base(AIType.AI_Melee)
    {
    ...
    public override string DefaultName => "a mire skulker";
