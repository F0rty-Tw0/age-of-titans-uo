...
public partial class WyldPuma : BaseCreature
{
    [Constructible]
    public WyldPuma() : base(AIType.AI_Melee)
    {
        Body = 0xD6;
        Hue = 0x0486;
        BaseSoundID = 0x462;
    ...
    public override string CorpseName => "a silverpelt corpse";
    public override string DefaultName => "a silverpelt panther";
