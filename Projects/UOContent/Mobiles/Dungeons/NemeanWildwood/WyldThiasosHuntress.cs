...
public partial class WyldThiasosHuntress : BaseCreature
{
    [Constructible]
    public WyldThiasosHuntress() : base(AIType.AI_Archer)
    {
        Body = 0x190;
        Hue = 0x0486;
    ...
    public override string CorpseName => "a Thiasos huntress's corpse";
    public override string DefaultName => "a Thiasos huntress";
