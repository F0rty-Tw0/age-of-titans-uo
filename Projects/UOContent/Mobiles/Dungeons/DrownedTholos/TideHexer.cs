...
public partial class TideHexer : BaseCreature
{
    [Constructible]
    public TideHexer() : base(AIType.AI_Mage)
    {
        Body = 148;
        Hue = 0x0532;
        BaseSoundID = 451;
    ...
    public override string CorpseName => "a hexer's corpse";
    public override string DefaultName => "a drowned hexer";
