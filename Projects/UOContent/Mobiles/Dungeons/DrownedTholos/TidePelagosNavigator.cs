...
public partial class TidePelagosNavigator : BaseCreature
{
    [Constructible]
    public TidePelagosNavigator() : base(AIType.AI_Mage)
    {
        Body = 26;
        Hue = 0x0532;
        BaseSoundID = 0x482;
    ...
    public override string CorpseName => "the navigator's corpse";
    public override string DefaultName => "the Pelagos navigator";
