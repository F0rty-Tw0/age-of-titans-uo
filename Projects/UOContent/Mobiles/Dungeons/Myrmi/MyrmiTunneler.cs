...
// The Myrmex Nest — Expansion (dev-docs/gap-families-bestiary.md §6.4e) - Aiakid war-brood, L3 trash. Donor: Ant Lion.
[SerializationGenerator(0, false)]
public partial class MyrmiTunneler : BaseCreature
{
    [Constructible]
    public MyrmiTunneler() : base(AIType.AI_Melee)
    {
        Body = 787;
        Hue = 0x0964;
        BaseSoundID = 1006;
    ...
    public override string CorpseName => "a myrmex tunneler's corpse";
    public override string DefaultName => "a myrmex tunneler";
