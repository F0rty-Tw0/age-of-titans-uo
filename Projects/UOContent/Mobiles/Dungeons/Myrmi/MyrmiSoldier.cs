...
// The Myrmex Nest (dev-docs/gap-families-bestiary.md §6.4) - Solen Hive + Terathan swarm, L4 trash. Donor: Black Solen Warrior.
[SerializationGenerator(0, false)]
public partial class MyrmiSoldier : BaseCreature
{
    [Constructible]
    public MyrmiSoldier() : base(AIType.AI_Melee)
    {
        Body = 806;
        Hue = 0x0966;
        BaseSoundID = 959;
    ...
    public override string CorpseName => "a myrmex soldier's corpse";
    public override string DefaultName => "a myrmex soldier";
