...
public partial class MyrmiAiakidShield : BaseCreature
{
    [Constructible]
    public MyrmiAiakidShield() : base(AIType.AI_Melee)
    {
        Body = 806;
        Hue = 0x0021;
        BaseSoundID = 959;
    ...
    public override string CorpseName => "an Aiakid shield-ant's corpse";
    public override string DefaultName => "an Aiakid shield-ant";
