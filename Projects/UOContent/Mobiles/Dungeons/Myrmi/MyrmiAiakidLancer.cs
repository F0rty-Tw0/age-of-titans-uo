...
public partial class MyrmiAiakidLancer : BaseCreature
{
    [Constructible]
    public MyrmiAiakidLancer() : base(AIType.AI_Melee)
    {
        Body = 70;
        Hue = 0x0798;
        BaseSoundID = 589;
    ...
    public override string CorpseName => "an Aiakid lancer's corpse";
    public override string DefaultName => "an Aiakid lancer";
