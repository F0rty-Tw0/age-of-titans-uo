...
// The Accursed Dig (dev-docs/gap-families-bestiary.md §6.3e) - Khaldun. L6 trash. Donor: Evil Mage.
[SerializationGenerator(0, false)]
public partial class CursedLampadTorch : BaseCreature
{
    [Constructible]
    public CursedLampadTorch() : base(AIType.AI_Mage)
    {
        Body = 0x190;
        Hue = 0x0842;
    ...
    public override string DefaultName => "a Lampad torchbearer";
