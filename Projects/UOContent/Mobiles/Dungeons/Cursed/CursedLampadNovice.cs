...
// The Accursed Dig (dev-docs/gap-families-bestiary.md §6.3e) - Khaldun. L5 trash. Donor: Evil Mage.
[SerializationGenerator(0, false)]
public partial class CursedLampadNovice : BaseCreature
{
    [Constructible]
    public CursedLampadNovice() : base(AIType.AI_Mage)
    {
        Body = 0x190;
        Hue = 0x0486;
    ...
    public override string DefaultName => "a Lampad novice";
