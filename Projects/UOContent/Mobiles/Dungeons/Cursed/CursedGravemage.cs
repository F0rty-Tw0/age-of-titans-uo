...
// The Accursed Dig (dev-docs/gap-families-bestiary.md §6.3e) - Khaldun. L6 trash. Donor: Lich.
[SerializationGenerator(0, false)]
public partial class CursedGravemage : BaseCreature
{
    [Constructible]
    public CursedGravemage() : base(AIType.AI_Mage)
    {
        Body = 24;
        Hue = 0x0486;
        BaseSoundID = 0x3E9;
    ...
    public override string CorpseName => "a lich's withered corpse";
    public override string DefaultName => "a barrow magus";
