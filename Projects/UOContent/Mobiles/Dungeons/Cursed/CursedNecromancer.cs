...
// The Accursed Dig (dev-docs/gap-families-bestiary.md §6.3) - Khaldun. L6 trash. Donor: Skeletal Mage.
[SerializationGenerator(0, false)]
public partial class CursedNecromancer : BaseCreature
{
    [Constructible]
    public CursedNecromancer() : base(AIType.AI_Mage)
    {
        Body = 148;
        Hue = 0x0486;
        BaseSoundID = 451;
    ...
    public override string DefaultName => "a Hecate necromancer";
