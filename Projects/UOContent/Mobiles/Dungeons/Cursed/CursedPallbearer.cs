...
// The Accursed Dig (dev-docs/gap-families-bestiary.md §6.3e) - Khaldun. L5 trash. Donor: Zombie.
[SerializationGenerator(0, false)]
public partial class CursedPallbearer : BaseCreature
{
    [Constructible]
    public CursedPallbearer() : base(AIType.AI_Melee)
    {
        Body = 3;
        Hue = 0x0842;
        BaseSoundID = 471;
    ...
    public override string CorpseName => "a cursed pallbearer's remains";
    public override string DefaultName => "a cursed pallbearer";
