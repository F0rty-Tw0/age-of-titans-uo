...
// The Accursed Dig (dev-docs/gap-families-bestiary.md §6.3) - Khaldun. L5 trash. Donor: Skeleton.
[SerializationGenerator(0, false)]
public partial class CursedDelver : BaseCreature
{
    [Constructible]
    public CursedDelver() : base(AIType.AI_Melee)
    {
    ...
    public override string CorpseName => "a cursed delver's remains";
    public override string DefaultName => "a cursed delver";
