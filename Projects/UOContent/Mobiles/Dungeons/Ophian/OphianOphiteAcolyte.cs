...
// The Coiled Sanctum — Expansion (dev-docs/gap-families-bestiary.md §6.5e) - Ophite hierophants, L4 trash. Donor: Ophidian Mage.
[SerializationGenerator(0, false)]
public partial class OphianOphiteAcolyte : BaseCreature
{
    [Constructible]
    public OphianOphiteAcolyte() : base(AIType.AI_Mage)
    {
        Body = 85;
        Hue = 0x0847;
        BaseSoundID = 639;
    ...
    public override string CorpseName => "an Ophite acolyte's corpse";
    public override string DefaultName => "an Ophite acolyte";
