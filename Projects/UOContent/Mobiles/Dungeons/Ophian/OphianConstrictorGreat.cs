...
// The Coiled Sanctum — Expansion (dev-docs/gap-families-bestiary.md §6.5e) - Terathan Keep serpents, L6 trash. Donor: Giant Serpent.
[SerializationGenerator(0, false)]
public partial class OphianConstrictorGreat : BaseCreature
{
    [Constructible]
    public OphianConstrictorGreat() : base(AIType.AI_Melee)
    {
        Body = 0x15;
        Hue = 0x0453;
        BaseSoundID = 219;
    ...
    public override string CorpseName => "a great constrictor's corpse";
    public override string DefaultName => "a great constrictor";
