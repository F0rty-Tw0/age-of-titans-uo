...
// The Coiled Sanctum — Expansion (dev-docs/gap-families-bestiary.md §6.5e) - Terathan Keep serpents, L6 trash. Donor: Ophidian Archmage.
[SerializationGenerator(0, false)]
public partial class OphianSerpentmage : BaseCreature
{
    [Constructible]
    public OphianSerpentmage() : base(AIType.AI_Mage)
    {
        Body = 85;
        Hue = 0x0851;
        BaseSoundID = 639;
    ...
    public override string CorpseName => "an ophian serpent-mage's corpse";
    public override string DefaultName => "an ophian serpent-mage";
