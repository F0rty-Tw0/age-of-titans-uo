...
public partial class OphianBroodmother : BaseCreature
{
    [Constructible]
    public OphianBroodmother() : base(AIType.AI_Mage)
    {
        Body = 87;
        Hue = 0x0851;
        BaseSoundID = 644;
    ...
    public override string CorpseName => "an ophian brood-mother's corpse";
    public override string DefaultName => "an ophian brood-mother";
