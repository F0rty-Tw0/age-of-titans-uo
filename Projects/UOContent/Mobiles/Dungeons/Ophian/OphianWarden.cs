...
// The Coiled Sanctum — Expansion (dev-docs/gap-families-bestiary.md §6.5e) - Terathan Keep serpents, L4 trash. Donor: Ophidian Warrior.
[SerializationGenerator(0, false)]
public partial class OphianWarden : BaseCreature
{
    [Constructible]
    public OphianWarden() : base(AIType.AI_Melee)
    {
        Body = 86;
        Hue = 0x0798;
        BaseSoundID = 634;
    ...
    public override string CorpseName => "an ophian scale-warden's corpse";
    public override string DefaultName => "an ophian scale-warden";
