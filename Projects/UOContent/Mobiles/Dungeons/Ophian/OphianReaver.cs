...
// The Coiled Sanctum (dev-docs/gap-families-bestiary.md §6.5) - Terathan Keep serpents, L5 trash. Donor: Ophidian Warrior.
[SerializationGenerator(0, false)]
public partial class OphianReaver : BaseCreature
{
    [Constructible]
    public OphianReaver() : base(AIType.AI_Melee)
    {
        Body = 86;
        Hue = 0x0453;
        BaseSoundID = 634;
    ...
    public override string CorpseName => "an ophian reaver's corpse";
    public override string DefaultName => "an ophian reaver";
