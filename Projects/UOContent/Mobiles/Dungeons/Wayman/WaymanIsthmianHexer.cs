...
// The Wayman's Toll — Expansion (dev-docs/gap-families-bestiary.md §6.8e) - Isthmian wreckers. L5 trash. Donor: Juka Mage.
[SerializationGenerator(0, false)]
public partial class WaymanIsthmianHexer : BaseCreature
{
    [Constructible]
    public WaymanIsthmianHexer() : base(AIType.AI_Mage)
    {
        Body = 765;
        Hue = 0x0000;
    ...
    public override string CorpseName => "an Isthmian hedge-hexer's corpse";
    public override string DefaultName => "an Isthmian hedge-hexer";
