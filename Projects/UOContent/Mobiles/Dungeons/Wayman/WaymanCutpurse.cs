...
public partial class WaymanCutpurse : BaseCreature
{
    [Constructible]
    public WaymanCutpurse() : base(AIType.AI_Melee)
    {
        Hue = 0x0844;
        ...
        SetSkill(SkillName.Fencing, 55.0, 70.0);
    ...
    public override string CorpseName => "a road cutpurse's corpse";
    public override string DefaultName => "a road cutpurse";
