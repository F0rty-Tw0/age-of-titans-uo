...
// (bow-equipped ranged row; body/idiom shared with Ruffian).
[SerializationGenerator(0, false)]
public partial class WaymanBowman : BaseCreature
{
    [Constructible]
    public WaymanBowman() : base(AIType.AI_Archer)
    {
        Body = 764;
        Hue = 0x0964;
    ...
    public override string CorpseName => "a Wayman bowman's corpse";
    public override string DefaultName => "a Wayman bowman";
