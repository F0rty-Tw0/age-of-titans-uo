...
public partial class WaymanRuffian : BaseCreature
{
    [Constructible]
    public WaymanRuffian() : base(AIType.AI_Melee)
    {
        Body = 764;
        Hue = 0x0844;
    ...
    public override string CorpseName => "a Wayman ruffian's corpse";
    public override string DefaultName => "a Wayman ruffian";
