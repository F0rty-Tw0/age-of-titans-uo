...
// The Wayman's Toll — Expansion (dev-docs/gap-families-bestiary.md §6.8e) - Wrong. L5 trash. Donor: Juka Mage.
[SerializationGenerator(0, false)]
public partial class WaymanRoadwitch : BaseCreature
{
    [Constructible]
    public WaymanRoadwitch() : base(AIType.AI_Mage)
    {
        Body = 765;
        Hue = 0x0000;
    ...
    public override string CorpseName => "a Wayman road-witch's corpse";
    public override string DefaultName => "a Wayman road-witch";
