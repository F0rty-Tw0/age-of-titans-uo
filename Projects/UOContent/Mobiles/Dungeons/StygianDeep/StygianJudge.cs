...
public partial class StygianJudge : BaseCreature
{
    [Constructible]
    public StygianJudge() : base(AIType.AI_Mage)
    {
        Body = 24;
        Hue = 0x0454;
        BaseSoundID = 0x3E9;
    ...
    public override string CorpseName => "a judge of the dead's corpse";
    public override string DefaultName => "a judge of the dead";
