...
public partial class StygianTormentor : BaseCreature
{
    [Constructible]
    public StygianTormentor() : base(AIType.AI_Mage)
    {
        Body = 26;
        Hue = 0x0454;
        BaseSoundID = 0x482;
    ...
    public override string CorpseName => "a tormentor shade's corpse";
    public override string DefaultName => "a tormentor shade";
