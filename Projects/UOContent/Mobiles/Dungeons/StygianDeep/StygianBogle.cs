...
public partial class StygianBogle : BaseCreature
{
    [Constructible]
    public StygianBogle() : base(AIType.AI_Mage)
    {
        Body = 153;
        Hue = 0x0455;
        BaseSoundID = 0x482;
    ...
    public override string CorpseName => "a mournful bogle's corpse";
    public override string DefaultName => "a mournful bogle";
