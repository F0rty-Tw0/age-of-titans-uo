...
// The Arcadian Warband — Expansion (dev-docs/gap-families-bestiary.md §6.6e) - the Lykaonid wolf-sons, L3 trash. Donor: Dire Wolf.
[SerializationGenerator(0, false)]
public partial class LykaiLykaonidWhelp : BaseCreature
{
    [Constructible]
    public LykaiLykaonidWhelp() : base(AIType.AI_Melee)
    {
        Body = 23;
        Hue = 0x0483;
        BaseSoundID = 0xE5;
    ...
    public override string CorpseName => "a Lykaonid whelp's corpse";
    public override string DefaultName => "a Lykaonid whelp";
