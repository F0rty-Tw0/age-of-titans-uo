...
// The Arcadian Warband (dev-docs/gap-families-bestiary.md §6.6) - Orc Caves, L3 trash. Donor: Orc.
[SerializationGenerator(0, false)]
public partial class LykaiRaider : BaseCreature
{
    [Constructible]
    public LykaiRaider() : base(AIType.AI_Melee)
    {
        Body = 17;
        Hue = 0x0844;
        BaseSoundID = 0x45A;
    ...
    public override string CorpseName => "an Arcadian raider's corpse";
    public override string DefaultName => "an Arcadian raider";
