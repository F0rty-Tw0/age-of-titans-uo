...
// The Arcadian Warband — Expansion (dev-docs/gap-families-bestiary.md §6.6e) - feral warband, L4 trash. Donor: Orcish Mage.
[SerializationGenerator(0, false)]
public partial class LykaiWitchdoctor : BaseCreature
{
    [Constructible]
    public LykaiWitchdoctor() : base(AIType.AI_Mage)
    {
        Body = 140;
        Hue = 0x0021;
        BaseSoundID = 0x45A;
    ...
    public override string CorpseName => "a wolf-cult witch-doctor's corpse";
    public override string DefaultName => "a wolf-cult witch-doctor";
