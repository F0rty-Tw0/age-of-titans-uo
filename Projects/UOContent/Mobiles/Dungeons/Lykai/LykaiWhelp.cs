...
// The Arcadian Warband — Expansion (dev-docs/gap-families-bestiary.md §6.6e) - feral warband, L2 trash. Donor: Ratman.
[SerializationGenerator(0, false)]
public partial class LykaiWhelp : BaseCreature
{
    [Constructible]
    public LykaiWhelp() : base(AIType.AI_Melee)
    {
        Body = 42;
        Hue = 0x0483;
        BaseSoundID = 437;
    ...
    public override string CorpseName => "a wolf-cult whelp's corpse";
    public override string DefaultName => "a wolf-cult whelp";
