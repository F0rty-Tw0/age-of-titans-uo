...
// The Arcadian Warband (dev-docs/gap-families-bestiary.md §6.6) - Orc Caves, L2 trash. Donor: Giant Rat.
[SerializationGenerator(0, false)]
public partial class LykaiWretch : BaseCreature
{
    [Constructible]
    public LykaiWretch() : base(AIType.AI_Melee)
    {
        Body = 0xD7;
        Hue = 0x0964;
        BaseSoundID = 0x188;
    ...
    public override string CorpseName => "a caves wretch's corpse";
    public override string DefaultName => "a caves wretch";
