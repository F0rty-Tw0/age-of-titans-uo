...
// The Arcadian Warband — Expansion (dev-docs/gap-families-bestiary.md §6.6e) - ambient, L2 trash. Donor: Giant Rat.
[SerializationGenerator(0, false)]
public partial class LykaiRatling : BaseCreature
{
    [Constructible]
    public LykaiRatling() : base(AIType.AI_Melee)
    {
        Body = 0xD7;
        Hue = 0x0964;
        BaseSoundID = 0x188;
    ...
    public override string CorpseName => "a cave ratling's corpse";
    public override string DefaultName => "a cave ratling";
