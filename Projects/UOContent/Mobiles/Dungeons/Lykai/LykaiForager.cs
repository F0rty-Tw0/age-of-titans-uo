...
public partial class LykaiForager : BaseCreature
{
    [Constructible]
    public LykaiForager() : base(AIType.AI_Melee)
    {
        Body = 17;
        Hue = 0x0844;
        BaseSoundID = 0x45A;
    ...
    public override string CorpseName => "an Arcadian forager's corpse";
    public override string DefaultName => "an Arcadian forager";
