...
// The Arcadian Warband — Expansion (dev-docs/gap-families-bestiary.md §6.6e) - feral warband, L4 trash. Donor: Dire Wolf.
[SerializationGenerator(0, false)]
public partial class LykaiHowler : BaseCreature
{
    [Constructible]
    public LykaiHowler() : base(AIType.AI_Melee)
    {
        Body = 23;
        Hue = 0x0483;
        BaseSoundID = 0xE5;
    ...
    public override string CorpseName => "a Lykaian howler's corpse";
    public override string DefaultName => "a Lykaian howler";
