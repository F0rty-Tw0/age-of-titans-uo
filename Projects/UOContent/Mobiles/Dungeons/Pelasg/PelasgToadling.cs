...
// The Painted Deep (dev-docs/gap-families-bestiary.md §6.9e) - Painted Caves. L2 ambient/fodder. Donor: Giant Toad.
[SerializationGenerator(0, false)]
public partial class PelasgToadling : BaseCreature
{
    [Constructible]
    public PelasgToadling() : base(AIType.AI_Melee)
    {
        Body = 80;
        Hue = 0x0844;
        BaseSoundID = 0x26B;
    ...
    public override string CorpseName => "a spotted toadling's corpse";
    public override string DefaultName => "a spotted toadling";
