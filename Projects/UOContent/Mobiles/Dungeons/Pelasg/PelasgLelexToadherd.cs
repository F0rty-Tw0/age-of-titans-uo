...
// The Painted Deep (dev-docs/gap-families-bestiary.md §6.9e) - Painted Caves, Leleges cave-clan. L3 trash. Donor: Giant Toad.
[SerializationGenerator(0, false)]
public partial class PelasgLelexToadherd : BaseCreature
{
    [Constructible]
    public PelasgLelexToadherd() : base(AIType.AI_Melee)
    {
        Body = 80;
        Hue = 0x0798;
        BaseSoundID = 0x26B;
    ...
    public override string CorpseName => "a Leleges toad-herd's corpse";
    public override string DefaultName => "a Leleges toad-herd";
