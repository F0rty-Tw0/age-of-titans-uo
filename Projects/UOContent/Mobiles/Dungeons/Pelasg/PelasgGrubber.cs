...
// The Painted Deep (dev-docs/gap-families-bestiary.md §6.9e) - Painted Caves. L2 trash. Donor: Giant Rat.
[SerializationGenerator(0, false)]
public partial class PelasgGrubber : BaseCreature
{
    [Constructible]
    public PelasgGrubber() : base(AIType.AI_Melee)
    {
        Body = 0xD7;
        Hue = 0x0844;
        BaseSoundID = 0x188;
    ...
    public override string CorpseName => "a cave grubber's corpse";
    public override string DefaultName => "a cave grubber";
