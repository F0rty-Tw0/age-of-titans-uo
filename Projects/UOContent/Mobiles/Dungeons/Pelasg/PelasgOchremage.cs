...
// The Painted Deep (dev-docs/gap-families-bestiary.md §6.9e) - Painted Caves. L4 trash. Donor: Orcish Mage.
[SerializationGenerator(0, false)]
public partial class PelasgOchremage : BaseCreature
{
    [Constructible]
    public PelasgOchremage() : base(AIType.AI_Mage)
    {
        Body = 140;
        Hue = 0x0798;
        BaseSoundID = 0x45A;
    ...
    public override string CorpseName => "a Pelasgian ochre-shaman's corpse";
    public override string DefaultName => "a Pelasgian ochre-shaman";
