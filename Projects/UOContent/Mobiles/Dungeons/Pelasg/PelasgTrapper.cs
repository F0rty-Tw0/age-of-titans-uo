...
// The Painted Deep (dev-docs/gap-families-bestiary.md §6.9e) - Painted Caves. L3 trash. Donor: Orc Bomber.
[SerializationGenerator(0, false)]
public partial class PelasgTrapper : BaseCreature
{
    [Constructible]
    public PelasgTrapper() : base(AIType.AI_Melee)
    {
        Body = 182;
        Hue = 0x0964;
        BaseSoundID = 0x45A;
    ...
    public override string CorpseName => "a Pelasgian trapper's corpse";
    public override string DefaultName => "a Pelasgian trapper";
