...
// The Painted Deep (dev-docs/gap-families-bestiary.md §6.9e) - Painted Caves, Leleges cave-clan. L3 trash. Donor: Troglodyte.
[SerializationGenerator(0, false)]
public partial class PelasgLelexKnapper : BaseCreature
{
    [Constructible]
    public PelasgLelexKnapper() : base(AIType.AI_Melee)
    {
        Body = 267;
        Hue = 0x0844;
        BaseSoundID = 0x59F;
    ...
    public override string CorpseName => "a Leleges flint-knapper's corpse";
    public override string DefaultName => "a Leleges flint-knapper";
