...
public partial class PelasgSpearman : BaseCreature
{
    [Constructible]
    public PelasgSpearman() : base(AIType.AI_Melee)
    {
        Body = 267;
        Hue = 0x0798;
        BaseSoundID = 0x59F;
    ...
    public override string CorpseName => "a Pelasgian spearman's corpse";
    public override string DefaultName => "a Pelasgian spearman";
