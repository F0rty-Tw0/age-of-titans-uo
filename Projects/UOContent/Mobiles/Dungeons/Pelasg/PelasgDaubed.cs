...
// The Painted Deep (dev-docs/gap-families-bestiary.md §6.9e) - Painted Caves. L3 trash. Donor: Orc.
[SerializationGenerator(0, false)]
public partial class PelasgDaubed : BaseCreature
{
    [Constructible]
    public PelasgDaubed() : base(AIType.AI_Melee)
    {
        Body = 17;
        Hue = 0x0844;
        BaseSoundID = 0x45A;
    ...
    public override string CorpseName => "a daubed hunter's corpse";
    public override string DefaultName => "a daubed hunter";
