...
public partial class PelasgForager : BaseCreature
{
    [Constructible]
    public PelasgForager() : base(AIType.AI_Melee)
    {
        Body = 267;
        Hue = 0x0798;
        BaseSoundID = 0x59F;
    ...
    public override string CorpseName => "a Pelasgian forager's corpse";
    public override string DefaultName => "a Pelasgian forager";
