...
public partial class PelasgWhelp : BaseCreature
{
    [Constructible]
    public PelasgWhelp() : base(AIType.AI_Melee)
    {
        Body = 267;
        Hue = 0x0798;
        BaseSoundID = 0x59F;
    ...
    public override string CorpseName => "a Pelasgian whelp's corpse";
    public override string DefaultName => "a Pelasgian whelp";
