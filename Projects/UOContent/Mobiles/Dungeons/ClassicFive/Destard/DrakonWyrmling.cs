...
// Classic Five bestiary (dev-docs/classic-five-bestiary.md) - Destard, Drakon family. L7 trash. Donor: Wyvern.
[SerializationGenerator(0, false)]
public partial class DrakonWyrmling : BaseCreature
{
    [Constructible]
    public DrakonWyrmling() : base(AIType.AI_Melee)
    {
        Body = 62;
        Hue = 0x066D;
        BaseSoundID = 362;
    ...
    public override string CorpseName => "a drakon wyrmling's corpse";
    public override string DefaultName => "a drakon wyrmling";
