...
public partial class BrineTempest : BaseCreature
{
    [Constructible]
    public BrineTempest() : base(AIType.AI_Mage)
    {
        Name = "a brine tempest";
    ...
    public override string CorpseName => "a brine tempest's remains";
