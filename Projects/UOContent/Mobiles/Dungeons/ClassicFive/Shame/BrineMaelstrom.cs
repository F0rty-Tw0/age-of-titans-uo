...
public partial class BrineMaelstrom : BaseCreature
{
    // Undertow pulse cadence; non-serialized, rebuilds naturally on restart.
    private DateTime _nextPulse;

    [Constructible]
    public BrineMaelstrom() : base(AIType.AI_Mage)
    {
        Name = "a brine maelstrom";
    ...
    public override string CorpseName => "a brine maelstrom's remains";
    ...
    public override void OnThink()
    {
        ...
        // Undertow: cold AoE that punishes clumping.
