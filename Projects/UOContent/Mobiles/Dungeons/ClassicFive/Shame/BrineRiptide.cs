...
public partial class BrineRiptide : BaseCreature
{
    [Constructible]
    public BrineRiptide() : base(AIType.AI_Mage)
    {
        Name = "a brine riptide";
    ...
    public override string CorpseName => "a brine riptide's remains";
