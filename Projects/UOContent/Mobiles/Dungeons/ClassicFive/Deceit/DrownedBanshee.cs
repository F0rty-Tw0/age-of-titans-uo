...
// Core expansion - the sunken garrison. L5 trash. Donor: Wraith.
[SerializationGenerator(0, false)]
public partial class DrownedBanshee : BaseCreature
{
    [Constructible]
    public DrownedBanshee() : base(AIType.AI_Mage)
    {
        Body = 26;
        Hue = 0x0841;
        BaseSoundID = 0x482;
    ...
    public override string DefaultName => "a drowned banshee";
