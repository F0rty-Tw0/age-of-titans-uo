...
// Classic Five bestiary (dev-docs/classic-five-bestiary.md) - Despise, Gaian expansion. L4 core. Donor: Ettin.
[SerializationGenerator(0, false)]
public partial class GaianQuarrybrute : BaseCreature
{
    [Constructible]
    public GaianQuarrybrute() : base(AIType.AI_Melee)
    {
        Body = 18;
        Hue = 0x0455;
        BaseSoundID = 367;
    ...
    public override string CorpseName => "a quarry brute's corpse";
    public override string DefaultName => "a quarry brute";
