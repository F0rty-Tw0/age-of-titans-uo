...
**Anti-abuse:** clamp. `CinderAutomaton`'s Overheat is the Outlands comeback lever —
...
alpha" lesson (elite is a caster/summoner, not a bigger sack of HP: the Outlands
...
### Signature variant — the Pantheon Sentinel line (Outlands recolor trick)
...
### Outlands patterns stolen (labelled)
