...
| **Amyntor** | Counter — amyntor, the defender | reflect 4% of melee damage taken | reflect 6%, slow self-repair | reflect 8%, self-repair — **every parry reflects an extra 6% on top of thorns (ParryExtraReflect)** | reflect 12%, self-repair — **every parry reflects an extra 6% on top of thorns (ParryExtraReflect)** (10→12 at Legendary, 2026-07-11 defense-sim pass; Probolos's block-elemental flat proc was simultaneously halved 10→5) |
