...
> dungeon (140 total)**, Outlands Aegis-Keep style (`dev-docs/outlands-bestiary.md`,
> `dev-docs/outlands-creatures.md` §3): one theme × an HP curve × role-appropriate resists =
